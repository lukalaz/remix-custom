      ...
      <div className="sm:flex items-center justify-end">
        <div className="mb-5">
          ...
          <div className="flex items-center sm:justify-end">
            <a className="inline-flex items-center justify-center w-9 h-9 sm:ml-3 rounded-sm bg-primary bg-opacity-10 text-body-color hover:bg-opacity-100 hover:text-white transition">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
