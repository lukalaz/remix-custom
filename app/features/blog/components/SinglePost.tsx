            ...
            <div>
              ...
              <div>
                <div className="sm:flex items-center justify-between">
                  <div className="mb-5">
                    ...
                    <div className="flex items-center">
                      <a
                        ...
                        className="inline-flex items-center justify-center py-2 px-4 mr-4 rounded-sm bg-primary bg-opacity-10 text-body-color hover:bg-opacity-100 hover:text-white transition"
                      >
                        Design
                      </a>
                      <a
                  ...
                  <div className="mb-5">
                    <h5 className="font-medium text-body-color text-sm sm:text-right mb-3">
                      Share this post :
                    </h5>
                    <div className="flex items-center sm:justify-end">
                      <a
                        href="javascript:void(0)"
                        className="inline-flex items-center justify-center w-9 h-9 sm:ml-3 rounded-sm bg-primary bg-opacity-10 text-body-color hover:bg-opacity-100 hover:text-white transition"
                      >
                        <svg
                          width="16"
                          height="16"
                      ...
                      <a
                        href="javascript:void(0)"
                        className="inline-flex items-center justify-center w-9 h-9 ml-3 rounded-sm bg-primary bg-opacity-10 text-body-color hover:bg-opacity-100 hover:text-white transition"
                      >
                        <svg
                          width="18"
                          height="14"
